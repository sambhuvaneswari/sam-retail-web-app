"""
Django settings for fp_rwa project.
...
SECRET_KEY = 'h223p9rw*i4a)j^@ln6s7-m8fn#vm33uv)=wddqdqt8t6+e2g1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', 'fp-sam-rwa-08012021.azurewebsites.net']
...
WSGI_APPLICATION = 'fp_rwa.wsgi.application'
